...
define("CopySpec", ["copy", "test/lib/mocked-jq", "test/lib/mocked-doc"], function(copy, mockedJQ, mockedDoc) {
  ...
  describe("Copy Command", function() {
    it("should copy the contents of element with id myElement.", function() {
        ...
        expect(mockedJQ.getCalls()).toEqual("find(#myElement);first();html();appendTo(body);val(ELEMENT CONTENTS TO COPY);select();execCommand();remove();");
    });
    ...
    it("should copy the attribute of element with id myElement2.", function() {
        ...
        expect(mockedJQ.getCalls()).toEqual("find(#myElement2);first();attr(attribute);appendTo(body);val(ATTRIBUTE VALUE TO COPY);select();execCommand();remove();");
    });
    ...
    it("should copy the data attribute of element with class myClass1.", function() {
        ...
        expect(mockedJQ.getCalls()).toEqual("find(.myClass1);first();data(attribute);appendTo(body);val(DATA ATTRIBUTE VALUE TO COPY);select();execCommand();remove();");
    });
